...
window.courses = [
    ...
    /*X*/ { name: "Fund. Análise Fonológica", credits: 4, code: "LEF150", semester: 2, requirements: [4], workload: 60},
    ...
    /*9*/ { name: "Aq. Inglês Segunda L.", credits: 4, code: "LEG112", semester: 3, requirements: [0,6], category: 1, workload: 60},
    /*10*/ { name: "Intro. Lit. L. Inglesa", credits: 4, code: "LEG231", semester: 3, requirements: [0,6], category: 1, workload: 60},
    /*11*/ { name: "Fonologia da LP", credits: 4, code: "LEV112", semester: 3, requirements: [2,8], category: 1, workload: 60},
    /*12*/ { name: "Lírica Latim", credits: 4, code: "LEC262", semester: 3, requirements: [9], category: 1, workload: 60},
    /*X*/ { name: "Fund. Análise Sintática", credits: 4, code: "LEF240", semester: 3, requirements: [4], workload: 60},
    /*X*/ { name: "Fund. Cult. Lit. Brasileira", credits: 2, code: "LEL287", semester: 3, requirements: [5], workload: 60},
    /*13*/ { name: "Educ. Linguística L. Inglesa", credits: 3, code: "LEG241", semester: 4, requirements: [13,14], category: 1, workload: 60},
    ...
    /*X*/ { name: "Ling. Lit. Latim: Narrativa", credits: 4, code: "LEC266", semester: 4, requirements: [13], workload: 60},
    ...
    /*17*/ { name: "Fonologia da L. Inglesa", credits: 4, code: "LEG301", semester: 5, requirements: [14], category: 1, workload: 60},
