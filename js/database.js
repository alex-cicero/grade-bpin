...
window.courses = [
    ...
    /*36*/ { name: "Atividades Acad. Livre Escolha", credits: 1, semester: 8, category: 1, workload: 30},    
    /*37*/ { name: "Tradução em L. Inglesa", credits: 4, code: "LEG472", requirements: [31], semester: 7, category: 1, workload: 60},
    /*38*/ { name: "Drama em Língua Inglesa", credits: 4, code: "LEG422", requirements: [32], semester: 7, category: 1, workload: 60},
    /*39*/ { name: "Semântica da LP", credits: 4, code: "LEV400", requirements: [2,8,15,21,27,33], semester: 7, category: 1, workload: 60},
    /*40*/ { name: "Temas e Prob. Lit. Brasileira", credits: 2, semester: 7, requirements: [34], category: 1, workload: 60},
    /*41*/ { name: "Atividades Acad. Optativas", credits: 5, semester: 7, step: 1, category: 2, workload: 120},
    /*42*/ { name: "PROJETO DE EXTENSÃO", credits: 160, code: "LEWX01", semester: 7, category: 1, workload: 160},
    /*43*/ { name: "L. Inglesa e Proc. de Global", credits: 4, code: "LEG401", semester: 8, requirements: [37], category: 1, workload: 60},
    /*44*/ { name: "A Literatura do Renascimento", credits: 4, code: "LEG430", semester: 8, requirements: [38], category: 1, workload: 60},
    /*45*/ { name: "Pesquisa em LP", credits: 2, code: "LEV488", requirements: [2,8,15,21,27,33,39], semester: 8, category: 1, workload: 30},
    /*46*/ { name: "História da LP", credits: 4, code: "LEV310", requirements: [2,8,15,21,27,33,39], semester: 8, category: 1, workload: 60},
