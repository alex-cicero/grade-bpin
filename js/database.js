...
window.courses = [
    ...
    [
    { name: "Gramática Txt L. Inglesa", credits: 5, code: "LEG113", semester: 1, category: 1, workload: 90},    
    { name: "Intro. L. Grega", credits: 4, code: "LEC111", semester: 1, category: 1, workload: 60},
    { name: "Prod. Leitura Txt. em LP", credits: 2, code: "LEV113", semester: 1, category: 1, workload: 60},
    { name: "Intro. L. Latina", credits: 4, code: "LEC160", semester: 1, category: 1, workload: 60},
    { name: "Fund. Linguística", credits: 4, code: "LEF140", semester: 1, category: 1, workload: 60},
    { name: "Teoria Literária I", credits: 4, code: "LEL100", semester: 1, category: 1, workload: 60},
    { name: "Prod. Escrita L. Inglesa", credits: 3, code: "LEG122", semester: 2, requirements: [0], category: 1, workload: 60},
    { name: "Intro. Lit. Grega", credits: 4, code: "LEC115", semester: 2, requirements: [1], workload: 60},
    { name: "Variação da LP", credits: 4, code: "LEV100", semester: 2, category: 1, workload: 60},
    { name: "Oratória Latim", credits: 4, code: "LEC166", semester: 2, requirements: [3], category: 1, workload: 60},
    { name: "Fund. Análise Fonológica", credits: 4, code: "LEF150", semester: 2, requirements: [4], category: 1, workload: 60},
    { name: "Teoria Literária II", credits: 4, code: "LEL110", semester: 2, workload: 60},
    { name: "Filosofia Educ. Mundo Ocid.", credits: 4, code: "EDF120", semester: 2, workload: 60},    
    { name: "Aq. Inglês Segunda L.", credits: 4, code: "LEG112", semester: 3, requirements: [0,6], category: 1, workload: 60},
    { name: "Intro. Lit. L. Inglesa", credits: 4, code: "LEG231", semester: 3, requirements: [0,6], category: 1, workload: 60},
    { name: "Fonologia da LP", credits: 4, code: "LEV112", semester: 3, requirements: [2,8], category: 1, workload: 60},
    { name: "Lírica Latim", credits: 4, code: "LEC262", semester: 3, requirements: [9], category: 1, workload: 60},
    { name: "Fund. Análise Sintática", credits: 4, code: "LEF240", semester: 3, requirements: [4], category: 1, workload: 60},
    { name: "Fund. Cult. Lit. Brasileira", credits: 2, code: "LEL287", semester: 3, requirements: [5], category: 1, workload: 60},
    { name: "Educ. Linguística L. Inglesa", credits: 3, code: "LEG241", semester: 4, requirements: [13,14], category: 1, workload: 60},
    { name: "Narrativa L. Inglesa I", credits: 4, code: "LEG222", semester: 4, category: 1, requirements: [13,14], workload: 60},
    { name: "Morfologia da LP", credits: 4, code: "LEV200", semester: 4, requirements: [2,8,15], category: 1, workload: 60},
