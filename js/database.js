...
window.courses = [
    ...
    /*36*/ { name: "OPTATIVA", credits: 2, code: "OPT001", semester: 6, category: 1, workload: 60},
    /*37*/ { name: "EXTENSÃO", credits: 6, code: "LEWX01", semester: 6, category: 1, workload: 90},
    /*38*/ { name: "Tradução em L. Inglesa", credits: 4, code: "LEG472", requirements: [2,8,15,21,27], semester: 7, category: 1, workload: 60},
    /*39*/ { name: "Drama em Língua Inglesa", credits: 4, code: "LEG422", requirements: [2,8,15,21,27], semester: 7, category: 1, workload: 60},
    /*40*/ { name: "Semântica da LP", credits: 4, code: "LEV400", requirements: [2,8,15,21,27,33], semester: 7, category: 1, workload: 60},
    /*41*/ { name: "Temas e Prob. Lit. Brasileira", credits: 8, semester: 7, step: 1, category: 2, workload: 120},
    /*42*/ { name: "Atividades Acad. Optativas", credits: 5, code: "COS480", semester: 7, category: 1, workload: 60},
    /*43*/ { name: "PROJETO DE EXTENSÃO", credits: 160, code: "LEWX01", semester: 7, category: 1, workload: 160},
    /*44*/ { name: "L. Inglesa e Proc. de Global", credits: 4, code: "LEG401", semester: 8, requirements: [38], category: 1, workload: 60},
    /*45*/ { name: "A Literatura do Renascimento", credits: 4, code: "LEG430", semester: 8, requirements: [39], category: 1, workload: 60},
    /*46*/ { name: "Pesquisa em LP", credits: 2, code: "LEV488", requirements: [2,8,15,21,27,33,40], semester: 8, category: 1, workload: 30},
    /*47*/ { name: "História da LP", credits: 4, code: "LEV310", requirements: [2,8,15,21,27,33,40], semester: 8, category: 1, workload: 60},
    /*46*/ { name: "Atividades Acad. Optativas", credits: 8, semester: 8, step: 1, category: 2, workload: 120},
    /*47*/ { name: "MONOGRAFIA", credits: 160, code: "LEWX01", semester: 8, category: 1, workload: 160},
    /*48*/ { name: "Atividades Acad. Livre Escolha", credits: 8, semester: 10, step: 1, category: 3, workload: 120},
    /*49*/ { name: "Ativ. Compl. Especiais", credits: 405, semester: 8, step: 15, category: 5, workload: 405},
    ]
]
