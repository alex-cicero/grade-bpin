...
window.courses = [
   [
    ...
    /*41*/ { name: "Atividades Acad. Livre Escolha", credits: 1, semester: 7, category: 1, workload: 30},    
    /*42*/ { name: "PROJETO DE EXTENSÃO", credits: 160, code: "LEWX01", semester: 7, category: 1, workload: 160},
    /*43*/ { name: "L. Inglesa e Proc. de Global", credits: 4, code: "LEG401", semester: 8, requirements: [36], category: 1, workload: 60},
    /*44*/ { name: "A Literatura do Renascimento", credits: 4, code: "LEG430", semester: 8, requirements: [37], category: 1, workload: 60},
    /*45*/ { name: "Pesquisa em LP", credits: 2, code: "LEV488", requirements: [2,8,15,21,27,33,38], semester: 8, category: 1, workload: 30},
    /*46*/ { name: "História da LP", credits: 4, code: "LEV310", requirements: [2,8,15,21,27,33,38], semester: 8, category: 1, workload: 60},
