...
window.courses = [
    ...
    { name: "Ling. Lit. Latim: Narrativa", credits: 4, code: "LEC266", semester: 4, requirements: [13], category: 1, workload: 60},
    { name: "Linguística e suas Aplicações", credits: 2, code: "LEF244", semester: 4, requirements: [4], workload: 30},
    { name: "Teoria Literária III", credits: 4, code: "LEL230", semester: 4, workload: 60},
    { name: "Fonologia da L. Inglesa", credits: 4, code: "LEG301", semester: 5, requirements: [13], category: 1, workload: 75},
    { name: "Lógica Matemática", credits: 4, code: "LEG241", semester: 5, category: 1, workload: 60},
